...
/mob/living/silicon/robot/proc/pick_module()
	...
	switch(modtype)
		...
		if("Combat")
			...
			module.channels = list("Security" = 1)
			module_sprites["Standard"] =  "droidcombat"

		if("Peacekeeper")
			module = new /obj/item/weapon/robot_module/peacekeeper(src)
			module.channels = list()
			module_sprites["Standard"] = "droidpeace"

		if("Hunter")
			module = new /obj/item/weapon/robot_module/alien/hunter(src)
			icon = "icons/mob/alien.dmi"
			module_sprites["Standard"] = "xenoborg-state-a"
			modtype = "Xeno-Hu"
...
//////////////////////////////////////////////////////////////////////////
	...
	// split & clean up
		...
		if(Entry[1] == src.ckey && Entry[2] == modtype)
			custom_sprite = 1
...
/mob/living/silicon/robot/proc/choose_icon(var/triesleft, var/list/module_sprites)
	...
	if(icontype in custom_icon)
		...
		custom_open = null
		var/file2 = file2text("config/custom_sprites_open.txt")
...
/mob/living/silicon/robot/verb/special_icon_pick()
	...
	if(normal || custom_sprite)
		to_chat(src, "You already have been able to select your icon.")
		return
